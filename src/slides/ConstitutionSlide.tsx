                        ...
                        >
                            ...
                            <List dense disablePadding sx={{color: 'var(--theme-text-heading)'}}>
                                <ListItem disablePadding disableGutters>
                                    <ListItemText primary={<>1. <strong>PRD</strong> (Why & What)</>}/>
                                </ListItem>
                                <ListItem disablePadding disableGutters>
                                    <ListItemText primary={<>2. <strong>Specification</strong> (How structured)</>}/>
                                </ListItem>
                                <ListItem disablePadding disableGutters>
                                    <ListItemText primary={<>3. <strong>Design</strong> (Implementation details)</>}/>
                                </ListItem>
                                <ListItem disablePadding disableGutters>
                                    <ListItemText primary={<>4. <strong>Tasks</strong> (Actionable steps)</>}/>
                                </ListItem>
                            </List>
                        </Paper>
                    </Grid>
                    <Grid size={6}>
                        <Typography variant="h3" sx={{mb: '12px'}}>厳格な依存関係</Typography>
                        <List disablePadding>
                            {[
                                ...
                                <ListItem key={text} disablePadding sx={{mb: '20px', pl: '30px', position: 'relative'}}>
                                    ...
                                    <ListItemText
                                        primary={text}
                                        slotProps={{
                                            primary: {sx: {fontSize: '20px', lineHeight: 1.6, color: 'var(--theme-text-body)'}},
                                        }}
                                    />
                                </ListItem>
                            ))}
